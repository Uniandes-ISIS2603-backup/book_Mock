 ...
 * "/api" y este recurso tiene la ruta "authors". 
...
public class AuthorResource {
     ...
     * @throws BookLogicException cuando ya existe un author con el id suministrado
     */
    @POST
     ...
     * @throws BookLogicException cuando no existe un author con el id suministrado
     */
    @PUT
    @Path("{id: \\d+}")
